...
- [x] Настоящая фрагментация TLS ClientHello (Fragment) для обхода DPI
...
- [x] Виджет быстрого включения/отключения на рабочий стол Android
- [x] Плитка быстрых настроек (Quick Settings Tile) в шторку Android
- [x] Встроенный Speedtest с резервным CDN и браузерным WAF-обходом
- [x] Интеллектуальный балансировщик (Автовыбор) серверов с авто-failover
- [x] Резервное копирование и экспорт/импорт конфигураций в JSON
- [x] Пользовательская маршрутизация доменов (Direct / Proxy / Block)
